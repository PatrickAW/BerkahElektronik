...
<head>
  ...
  <style>
    ...
    @media (max-width: 1200px) {
      ...
      body {
        padding-top: 70px; /* Sesuaikan untuk responsive */
      }
    }
    ...
    @media (max-width: 992px) {
      ...
      body {
        padding-top: 120px; /* Lebih besar karena navbar wrap */
      }
    }
    ...
    @media (max-width: 768px) {
      ...
      body {
        padding-top: 150px; /* Tambah lebih besar untuk mobile */
      }
    }
  </style>
